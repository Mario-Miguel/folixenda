    ...
    <div className="max-w-4xl mx-auto px-6 py-8">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="font-medium text-gray-800">{formatLongDate(new Date(event.date + "T12:00:00"), locale, true)}</p>
              </div>
            </div>
        ...
        <div className="lg:col-span-1">
          <div className="sticky top-24 bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            <div className="mb-4">
              ...
              <p className="text-3xl font-bold text-gray-900">{event.price === 0 ? t("common.free") : t("common.price", { price: event.price })}</p>
      ...
      {related.length > 0 && (
        <section className="mt-12">
          <h2 className="text-xl font-bold text-gray-900 mb-5">{t("event.moreCategoryEvents", { category: t(`categories.${event.category}`) })}</h2>
